...
import { Settings, X, Eye, EyeOff, Download, Users, Mail, Clock, ArrowUpCircle } from "lucide-react";
        ...
        <div className="border-t border-white/20 mt-10 pt-6 md:mt-12 md:pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            ...
            <div className="flex items-center space-x-4 md:space-x-6">
              {/* Could add Privacy Policy / Terms links here if needed */}
              {/* <a href="#" className="text-xs text-white/50 hover:text-white/70">Privacy</a> */}
              {/* <a href="#" className="text-xs text-white/50 hover:text-white/70">Terms</a> */}
              <button
