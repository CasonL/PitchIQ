...
export interface MarcusScenario {
  ...
  // Relationship context (for realistic openings)
  relationshipHistory?: {
    type: 'cold_outbound' | 'email_signup_curious' | 'tried_product_didnt_fit' | 'referral_mention' | 'knows_company';
    context: string;  // Injected into Marcus's prompt before first response
  };
...
export const ADAPTIVE_SCENARIO: MarcusScenario = {
  ...
  // Relationship context - randomly selected per call for variety
  relationshipHistory: {
    type: 'email_signup_curious',
    context: 'You put your email in their form a few weeks ago out of curiosity, but you weren\'t really in pain. You acted more out of casual interest than urgent need. You barely remember what they do.'
  },
