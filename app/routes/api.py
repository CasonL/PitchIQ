...
@api.route('/user/metrics', methods=['GET'])
@login_required
def user_metrics():
...
@api.route('/sessions/<int:session_id>/transcript', methods=['GET'])
@login_required
...
@api.route('/insights/generate', methods=['GET'])
@login_required
...
@api.route('/insights/chat', methods=['POST'])
@login_required
def insight_chat():
