...
const Footer = () => {
  return (
    <footer className="py-12 md:py-16 px-6 md:px-10 lg:px-20 bg-pitchiq-dark text-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="text-2xl font-bold mb-6">PitchIQ</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Reviews</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Sales Tips</a></li>
