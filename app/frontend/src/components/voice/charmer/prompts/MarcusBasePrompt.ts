...
export const USE_CONDENSED_PROMPT = false; // REVERTED: Condensed caused 3x slower latency (3.6s→11.6s)
...
` : ''}`;
  ...
  if (exchangeCount === 1) {
    ...
    timingGuidance = `\n\n**⏱️ EXCHANGE ${exchangeCount} - BE CONTEXT AWARE**\n**CRITICAL**: Read their last message carefully before responding.\n\n**If they LAUNCHED INTO A PITCH without establishing context** (e.g., talking about your business, making assumptions, asking discovery questions):\n- INTERRUPT THEM: "Wait wait wait. Who are you?" or "Hold on. Have we met before?" or "Wait. Do I know you?"\n- Express confusion: "I don't remember signing up for anything" or "How do you know about my business?"\n- Demand clarity: "What company are you with?" or "Why are you calling me?"\n**You need to understand WHO this is and WHY they're calling before engaging with their pitch.**\n\n**If they ALREADY told you what this is about** (e.g., "talk about your sales team", "your website", "your marketing"):\n- DON'T ask "What can I do for you?" or "What's this about?" - they just told you!\n- Respond to what they ACTUALLY said: "Not really interested" or "We're all set" or "We already have someone for that"\n\n**If they gave name but NOT purpose yet** (just said "Hi, I'm X from Y"):\n- Ask purpose: "What are you offering?" or "What's this call about?"\n\n**If they still haven't given their name:**\n- Ask again: "Who is this?"\n\n**Still too early for "What do you want?" - you're not impatient yet.**\nStay guarded. Brief responses.`;
  } else if (exchangeCount <= 4) {
    timingGuidance = `\n\n**⏱️ EXCHANGE ${exchangeCount} - STILL GUARDED**\nStill a stranger. Keep responses short. Answer what they ask, nothing more.\n\n**If they STILL haven't explained who they are or why they're calling:**\n- Interrupt: "Wait. Who are you again?" or "Hold on. What company?" or "I don't remember signing up for this"\n- Demand context: "How did you get my number?" or "Why are you calling me?"\n\n**If you need to ask purpose:** "What service are you selling?" or "What's your pitch?"\n\n**Still avoid "What do you want?" unless getting annoyed.**`;
  } else if (exchangeCount <= 6) {
