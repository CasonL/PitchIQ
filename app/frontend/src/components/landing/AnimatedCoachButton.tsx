...
import { BrainCircuit, User, Mail } from 'lucide-react';
        ...
        {cardState === 'button' ? (
          ...
          >
            ...
            <div>
              ...
              <span className="text-sm text-muted-foreground">Click to Start Your Demo</span>
            </div>
          </motion.div>
        ) : (
          <motion.div
...
export default AnimatedCoachButton; 